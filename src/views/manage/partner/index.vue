<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="partnerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="400px">
        <template #default="scope">
          <el-button link type="primary" icon="View" @click="resetPwd(scope.row)" v-hasPermi="['manage:partner:reset']">重置密码</el-button>
          <el-button link type="primary" icon="View" @click="getPartnerInfo(scope.row)" v-hasPermi="['manage:partner:query']">查看详情</el-button>
    ...
    <!-- 查看合作商详情对话框 -->
        <el-dialog :title="title" v-model="partnerInfoOpen" width="400px" append-to-body>
...
function resetPwd(row) {
  const _id = row.id;
  proxy.$modal.confirm('是否确认重置当前合作商密码？').then(function() {
